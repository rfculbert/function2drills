...
const multiply = (numOne, numTwo, callBack) => callBack(numOne * numTwo) 
...
const each = (namesArr, callBack) => namesArr.forEach((element, i) => callBack(element, i))
...
const addingFactory = (num) => {
  return function secondNum(numTwo){
    return (num + numTwo)
  }
}
...
const addSixtyNine = addingFactory(69)
console.log(addSixtyNine(0))
